...
| [boost_library_docs_tracker.services](boost_library_docs_tracker.md) | boost_library_docs_tracker | BoostDocContent (global page by URL) and BoostLibraryDocumentation (library-version × page with status). |
...
- **boost_library_docs_tracker** – Get-or-create BoostDocContent (by URL); link to BoostLibraryVersion via BoostLibraryDocumentation; track scrape/sync status.
