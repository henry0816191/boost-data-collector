...
Wraps github_activity_tracker.preprocessors.github_preprocess.preprocess_prs
...
Usage (via run_cppa_pinecone_sync or run_clang_github_tracker):
    ...
    preprocessor = clang_github_tracker.preprocessors.pr_preprocessor.preprocess_for_pinecone
"""
...
from github_activity_tracker.preprocessors.github_preprocess import preprocess_prs
