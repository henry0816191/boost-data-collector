...
def test_fetch_commits_single_page_yields_oldest_first():
    ...
    client.rest_request.side_effect = lambda url: {"sha": url.split("/")[-1], "stats": {}}
...
def test_fetch_commits_multiple_pages_backward_traversal():
    ...
    client.rest_request_with_all_links.return_value = (
        ...
        {"next": "https://api.github.com/repos/o/r/commits?page=2", "last": "https://api.github.com/repos/o/r/commits?page=3"},
    )
    ...
    client.rest_request_url_with_all_links.side_effect = [
        ...
        (
            [{"sha": "c1", "commit": {"author": {"date": "2024-01-01T00:00:00Z"}}}],
            {"prev": "https://api.github.com/repos/o/r/commits?page=2", "first": "https://api.github.com/repos/o/r/commits?page=1"},
        ),
        # Page 2
        (
            [{"sha": "c5", "commit": {"author": {"date": "2024-01-05T00:00:00Z"}}}],
            {"prev": "https://api.github.com/repos/o/r/commits?page=1", "first": "https://api.github.com/repos/o/r/commits?page=1"},
        ),
...
def test_fetch_commits_filters_by_date_range():
    ...
    commits = list(fetch_commits_from_github(client, "o", "r", start_time=start, end_time=end))
