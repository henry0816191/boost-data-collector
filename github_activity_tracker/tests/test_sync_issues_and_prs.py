...
def test_sync_issues_and_prs_processes_both_types(
    ...
    with patch("github_activity_tracker.sync.issues_and_prs._process_issue_data") as mock_proc_issue, \
         patch("github_activity_tracker.sync.issues_and_prs._process_pr_data") as mock_proc_pr, \
         ...
         patch("github_activity_tracker.sync.issues_and_prs.get_issue_json_path") as mock_issue_path, \
         patch("github_activity_tracker.sync.issues_and_prs.get_pr_json_path") as mock_pr_path:
...
def test_sync_issues_and_prs_saves_and_removes_json_files(
    ...
    with patch("github_activity_tracker.sync.issues_and_prs._process_issue_data"), \
         patch("github_activity_tracker.sync.issues_and_prs.save_issue_raw_source"), \
         patch("github_activity_tracker.sync.issues_and_prs.get_issue_json_path", return_value=mock_json_path):
