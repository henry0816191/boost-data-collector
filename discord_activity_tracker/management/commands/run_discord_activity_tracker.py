...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS("✓ Discord activity tracker completed"))
        ...
        if dry_run:
            ...
            try:
                ...
                for channel in channels:
                    ...
                    self.stdout.write(f"    - #{channel.channel_name} (last sync: {last_sync})")
    ...
    def _task_export_markdown(
        ...
        if dry_run:
            ...
            self.stdout.write(f"  Would export {channels.count()} active channels to {context_repo_path}")
        ...
        if success:
            ...
            self.stdout.write(self.style.WARNING(f"  ⚠ Export failed"))
